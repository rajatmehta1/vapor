...
public class GenericModelTester {
	...
	//static String sentence = "Can i get a new cheque book";
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 2. Lower probability. Maybe because of more complex sentence
			// structure?
			...
			// 4. Lower probability. Maybe because title is at the beginning of
			// sentence? More complex, like 2.
			// The Call of the Wild ,
			...
			// 6. No title recognized when everything in lowercase. Clearly case
			// plays a big role.

			// 7. Odd. The lowercase "the" included with the title, unlike 5.
			// Note lowest probability.
			// the Odyssey ?
